...
| **Demo** | 3 seeded documents, 5 messages/session for anonymous users, 50 sessions/doc cap (global), forced Kimi K2.5 via NVIDIA NIM (free, zero OpenRouter cost), 10 req/min/IP rate limit, ModelSelector hidden |
