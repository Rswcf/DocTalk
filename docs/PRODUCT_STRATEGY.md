...
- **Strengths**: Citation precision (small chunks + bbox highlights), 9 LLM models via OpenRouter, OCR, dark mode, multi-language (9 languages), streaming indicators, auto-summary
