...
function VisualAnswers() {
  return (
    <div className="relative h-24 w-full overflow-hidden rounded-lg bg-gradient-to-br from-indigo-50 to-zinc-50 dark:from-indigo-950/40 dark:to-zinc-900/40 mb-5">
      <div className="absolute inset-0 flex flex-col justify-center px-4 gap-1.5">
        ...
        <div className="h-1.5 w-5/6 rounded-full bg-zinc-300 dark:bg-zinc-700" />
