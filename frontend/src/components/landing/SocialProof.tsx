        ...
        <div className="border-t border-zinc-200 dark:border-zinc-800 pt-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {metrics.map((metric) => (
              ...
              >
                <div className="text-4xl md:text-5xl font-bold tracking-tight bg-gradient-to-r from-blue-600 to-violet-600 dark:from-blue-400 dark:to-violet-400 bg-clip-text text-transparent mb-2 tabular-nums">
