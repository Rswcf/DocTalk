...
export default function ChatPanel({ sessionId, onCitationClick, onPreviewLayoutTranslation, maxUserMessages, suggestedQuestions, documentBrief, briefPolling = false, initialQuestion, onOpenSettings, hasCustomInstructions, userPlan, autoSubmitInitialQuestion = false, supportsCustomInstructions = true, onTryQuoteFinder }: ChatPanelProps) {
